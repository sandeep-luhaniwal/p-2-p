            ...
            <div className="flex flex-wrap gap-y-2.5 md:gap-y-5 gap-5">
                {[
                    ...
                    <div className="relative" ref={dropdown.ref} key={index}>
                        ...
                        <div
                            className={`absolute top-[110%] left-0 w-full min-w-[160px] bg-white border border-[#F0F2F4] rounded-md shadow-md transition-all duration-300 ${dropdown.showDropdown
